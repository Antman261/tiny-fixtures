 ...
 */
var tinyFixtures = function (pool, camelCased) {
    if (camelCased === void 0) { camelCased = false; }
    var createFixtures = function (table, rows, primaryKeyName) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        mapRowToInsertQuery = query_1.createRowToQueryMapper(table, pool, camelCased);
                        results = [];
        ...
        var teardownFixtures = function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, pool.query(query_1.buildDeleteQueryString(table, pkName, primaryKeys, camelCased))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
